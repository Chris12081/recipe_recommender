    ...
    try:
        ...
        for times in range(100):
            ...
            for i in range(100):
                ...
                # with open ("./dcard_fitness/txt/%s.txt"%(content_id),'w',encoding='utf-8') as f:
                ...
                with open('./dcard_fitness/json/%s.json'%(content_id),'w', encoding='utf-8') as f:
...
if __name__ ==  '__main__':
    ...
    result = getArticle(234386928) ##需要修改
end = time.time()
